...
def sha256(message):
    ...
    original_length_bits = len(message.encode('utf-8')) * 8  # Original length in bits (before padding)
    binary_length = f'{original_length_bits:064b}'

    # Step 4: Add padding zeros until the message length is congruent to 448 mod 512
    ...
    for chunk in chunks:
        ...
        # Step 8: Copy chunk into 1st 16 words w[0..15] of the message schedule array
        for i in range(16):
...
long_message = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged."
print(f"Sha256 (long) = {sha256(long_message)}")
